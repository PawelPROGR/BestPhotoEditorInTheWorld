...
export default function ImageList(){
    ...
    const imageAPI = (url = 'https://localhost:44334/api/Image/%27) => {
    return {
...
const navigate = useNavigate();
    ...
    const showViewPhoto = (i) => {
        navigate('/oneimage', {state:{id:i, data:useState[i]}})
    }
    const imageCard = data =>(
        <div className="card">
            ...
            <div className="card-body">
                ...
                <br/>
                <button type="submit" className="btn btn-light"  onClick={()=>{showViewPhoto(data.imageID)}}>
